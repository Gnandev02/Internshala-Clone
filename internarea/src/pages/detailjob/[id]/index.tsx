...
const Index = () => {
  ...
  useEffect(() => {
    if (id) {
      const foundJob = initialJobs.find((job) => job._id === id);
      if (foundJob) {
        setjob(foundJob);
      }
